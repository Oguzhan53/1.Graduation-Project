...
class Advisor extends React.Component{
  ...
  getStudents=()=> {
      fetch("http://localhost:8083/api/admin/null-advisor-student?"+
...
<div class="item">
        ...
        <Container>
          <Grid>
          <Header size="huge">STUDENTS WITHOUT ADVISOR </Header>
              ...
              <Grid.Column width={12}>
                ...
                <Table celled>
                    ...
                    <Table.Row>
                        ...
                        <Table.HeaderCell>Assign Advisor</Table.HeaderCell>
