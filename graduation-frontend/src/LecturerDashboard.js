...
class LecturerDashboard extends React.Component{
  ...
  changePageTo = (i) => {
      this.setState({currentPage : i}, this.getLecturer);
  };



  addConsultStudent = (id) => {
...
/* 
    ...
    fetch("http://localhost:8083/api/admin/lecturer/name/"+this.state.studentNum+"?"+
    new URLSearchParams({pageNumber: this.state.currentPage}),
    {
      method:"GET",
      headers:{
  ...
  removeLecturer=(id) =>{
    fetch("http://localhost:8083/api/admin/lecturer/"+id,
       {
          method : "DELETE",
          headers:{
            "Content-Type":"application/json",
...
<div class="item">
            ...
            <h3 class="ui header">Lecturers Dashboard</h3>
        ...
        <Container>
          <Grid>
          <Header size="huge">LECTURERS</Header>
            <Grid.Row columns="equal" centered>
              <Grid.Column width={13}>
                ...
                <Table celled>
                    ...
                    <Table.Row>
                        ...
                        <Table.HeaderCell width={2}>Lecturer Name</Table.HeaderCell>
                        <Table.HeaderCell  width={3}>Lecturer Surname</Table.HeaderCell>
                        <Table.HeaderCell width={3}>Department</Table.HeaderCell>
                        <Table.HeaderCell width={2}>Remove Lecturer</Table.HeaderCell>
                    ...
                    <Table.Body>
                        ...
                        lecturers.content.map((value,index)=>(
                            ...
                            <Table.Cell>
                              <Label ribbon>
                                {lecturers.size * lecturers.number +(index+1)}
                              </Label>
                            </Table.Cell>
                ...
                <Statistic floated='right'>
                    <Statistic.Value>{lecturers.totalElements}</Statistic.Value>
                    <Statistic.Label>Total Number Of Lecturers</Statistic.Label>
                </Statistic>
              ...
              <Grid.Column  centered relaxed='very' stackable width={2}>
