...
class LectureDahsboard extends React.Component{
  ...
  getLecture=()=> {
      fetch("http://localhost:8083/api/lecturer/all/lecture?"+
  ...
  getStLecture=()=> {
    fetch("http://localhost:8083/api/lecturer/waiting/lectures/"+localStorage.getItem("name"),
    {
        method : "GET",
        headers:{
          "Content-Type":"application/json",
...
/* 
    ...
    fetch("http://localhost:8083/api/lecturer/lecture/page/code/"+this.state.studentNum,
    {
      method:"GET",
      headers:{
        "Content-Type":"application/json",
  ...
  deleteLec=(code) =>{
    fetch("http://localhost:8083/api/lecturer/confirm/"+localStorage.getItem("id")+"/"+code+"/0",
       {
          method : "POST",
          headers:{
            "Content-Type":"application/json",
  ...
  addLecture=(code) =>{
    fetch("http://localhost:8083/api/lecturer/student/lecture/"+localStorage.getItem("name")+"/"+code,
       {
          method : "POST",
          headers:{
            "Content-Type":"application/json",
